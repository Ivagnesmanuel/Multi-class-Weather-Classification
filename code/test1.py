...
Original file is located at
    https://colab.research.google.com/drive/1htBcTlOQ_LMYnMaA1OUgdAEMbwpaxo63
"""
...
dataset = '/content/drive/My Drive/dataset_400'
...
#this first refers to the training set
...
#this second refers to the validation set
...
'''
filename = os.path.join(to_save, 'test1.h5')
model.save(filename)
